...
//fetch é uma promise, isso significa que pode dar certo ou errado.
// .then()é o caso de sucesso, ele vai buscar a requisição, se der certo cai dentro do .then.
// .catch() permite definir um bloco de instruções para ser executado em caso de erro.
